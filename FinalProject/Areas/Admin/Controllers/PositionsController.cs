...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Location,Work_time,Time")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id,[Bind(Include = "Id,Name,Location,Work_time,Time")] Position position)
        {
            if (ModelState.IsValid)
            {
