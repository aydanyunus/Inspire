...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class Bg503Controller : Controller
    {
        ...
        {
            return View(db.Bg503.ToList());
        }

        // GET: Admin/Bg503/Details/5
        ...
        // POST: Admin/Bg503/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Bg_img")] Bg503 bg503, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                Bg503 activebg = db.Bg503.Find(id);
                if (activebg != null)
                {
                    ...
                    if (Photo != null)
                    {
                        if (Photo.ContentLength > 0 && Photo.ContentLength <= 3 * 1024 * 1024)
                        {
                            ...
                            {
                                var path = Path.Combine(Server.MapPath("~/Uploads/"), activebg.Bg_img);
