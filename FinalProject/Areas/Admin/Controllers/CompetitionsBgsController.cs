...
{
    public class CompetitionsBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/CompetitionsBgs
        public ActionResult Index()
        {
            return View(db.CompetitionsBgs.ToList());
        }

        // GET: Admin/CompetitionsBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            CompetitionsBg competitionsBg = db.CompetitionsBgs.Find(id);
            if (competitionsBg == null)
            {
                return HttpNotFound();
            }
            return View(competitionsBg);
        }

        

        // GET: Admin/CompetitionsBgs/Edit/5
        ...
        // POST: Admin/CompetitionsBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] CompetitionsBg competitionsBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                CompetitionsBg activebg = db.CompetitionsBgs.Find(id);
                if (activebg != null)
                {
