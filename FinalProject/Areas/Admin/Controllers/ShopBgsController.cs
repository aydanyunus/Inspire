...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class ShopBgsController : Controller
    {
        ...
        {
            return View(db.ShopBgs.ToList());
        }

        // GET: Admin/ShopBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            ShopBg shopBg = db.ShopBgs.Find(id);
            if (shopBg == null)
            {
                return HttpNotFound();
            }
        ...
        // POST: Admin/ShopBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] ShopBg shopBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                ShopBg activebg = db.ShopBgs.Find(id);
                if (activebg != null)
                {
