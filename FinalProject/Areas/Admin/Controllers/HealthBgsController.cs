...
{
    public class HealthBgsController : Controller
    {
        ...
        {
            return View(db.HealthBgs.ToList());
        }

        // GET: Admin/HealthBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            HealthBg healthBg = db.HealthBgs.Find(id);
            if (healthBg == null)
            {
                return HttpNotFound();
            }
            return View(healthBg);
        }

       

        // GET: Admin/HealthBgs/Edit/5
        ...
        // POST: Admin/HealthBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] HealthBg healthBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                HealthBg activebg = db.HealthBgs.Find(id);
                if (activebg != null)
                {
