...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class OurTeamsController : Controller
    {
        ...
        {
            return View(db.OurTeams.ToList());
        }

        // GET: Admin/OurTeams/Details/5
        ...
        // POST: Admin/OurTeams/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img,Content")] OurTeam ourTeam, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                OurTeam active = db.OurTeams.Find(id);
                if (active != null)
                {
                    ...
                    if (Photo != null)
                    {
                        if (Photo.ContentLength > 0 && Photo.ContentLength <= 3 * 1024 * 1024)
                        {
                            ...
                            )
                            {
                                ...
                                active.Img = fileName;
                                active.Content = ourTeam.Content;
                                db.SaveChanges();
