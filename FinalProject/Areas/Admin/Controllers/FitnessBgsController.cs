...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class FitnessBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/FitnessBgs
        public ActionResult Index()
        {
            return View(db.FitnessBgs.ToList());
        }

        // GET: Admin/FitnessBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            FitnessBg fitnessBg = db.FitnessBgs.Find(id);
            if (fitnessBg == null)
            {
                return HttpNotFound();
            }
            return View(fitnessBg);
        }

       

        // GET: Admin/FitnessBgs/Edit/5
        ...
        // POST: Admin/FitnessBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] FitnessBg fitnessBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                FitnessBg activebg = db.FitnessBgs.Find(id);
                if (activebg != null)
                {
