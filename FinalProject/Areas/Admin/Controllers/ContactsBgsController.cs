...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class ContactsBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/ContactsBgs
        public ActionResult Index()
        {
            return View(db.ContactsBgs.ToList());
        }

        // GET: Admin/ContactsBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            ContactsBg contactsBg = db.ContactsBgs.Find(id);
            if (contactsBg == null)
            {
                return HttpNotFound();
            }
            return View(contactsBg);
        }

        

        // GET: Admin/ContactsBgs/Edit/5
        ...
        // POST: Admin/ContactsBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] ContactsBg contactsBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                ContactsBg activebg = db.ContactsBgs.Find(id);
                if (activebg != null)
                {
