...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class Bg404Controller : Controller
    {
        ...
        {
            return View(db.Bg404.ToList());
        }

        // GET: Admin/Bg404/Details/5
        ...
        // POST: Admin/Bg404/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Bg_img")] Bg404 bg404, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                Bg404 activebg = db.Bg404.Find(id);
                if (activebg != null)
                {
