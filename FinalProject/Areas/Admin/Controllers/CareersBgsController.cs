...
{
    public class CareersBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/CareersBgs
        public ActionResult Index()
        {
            return View(db.CareersBgs.ToList());
        }

        // GET: Admin/CareersBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            CareersBg careersBg = db.CareersBgs.Find(id);
            if (careersBg == null)
            {
                return HttpNotFound();
            }
            return View(careersBg);
        }

       

        // GET: Admin/CareersBgs/Edit/5
        ...
        // POST: Admin/CareersBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id,[Bind(Include = "Id,Img")] CareersBg careersBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                CareersBg activebg = db.CareersBgs.Find(id);
                if (activebg != null)
                {
