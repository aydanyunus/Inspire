...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class PartnerWithUsBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/PartnerWithUsBgs
        public ActionResult Index()
        {
            return View(db.PartnerWithUsBgs.ToList());
        }

        // GET: Admin/PartnerWithUsBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            PartnerWithUsBg partnerWithUsBg = db.PartnerWithUsBgs.Find(id);
            if (partnerWithUsBg == null)
            {
                return HttpNotFound();
            }
            return View(partnerWithUsBg);
        }

       

        // GET: Admin/PartnerWithUsBgs/Edit/5
        ...
        // POST: Admin/PartnerWithUsBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] PartnerWithUsBg partnerWithUsBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                PartnerWithUsBg activebg = db.PartnerWithUsBgs.Find(id);
                if (activebg != null)
                {
