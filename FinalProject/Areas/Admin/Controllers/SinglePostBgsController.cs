...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class SinglePostBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/SinglePostBgs
        public ActionResult Index()
        {
            return View(db.SinglePostBgs.ToList());
        }

        // GET: Admin/SinglePostBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            SinglePostBg singlePostBg = db.SinglePostBgs.Find(id);
            if (singlePostBg == null)
            {
                return HttpNotFound();
            }
            return View(singlePostBg);
        }

       
        // GET: Admin/SinglePostBgs/Edit/5
        ...
        // POST: Admin/SinglePostBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] SinglePostBg singlePostBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                SinglePostBg activebg = db.SinglePostBgs.Find(id);
                if (activebg != null)
                {
