...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class ComingSoonsController : Controller
    {
        ...
        // GET: Admin/ComingSoons
        public ActionResult Index()
        {
            return View(db.ComingSoons.ToList());
        }

        // GET: Admin/ComingSoons/Details/5
        ...
        // POST: Admin/ComingSoons/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id,[Bind(Include = "Id,Bg_img,SubTitle,Copywrite")] String Content, ComingSoon comingSoon, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                ComingSoon active = db.ComingSoons.Find(id);
                if (active != null)
                {
                    ...
                    if (Photo != null)
                    {
                        if (Photo.ContentLength > 0 && Photo.ContentLength <= 3 * 1024 * 1024)
                        {
                            ...
                            {
                                var path = Path.Combine(Server.MapPath("~/Uploads/"), active.Bg_img);
                                ...
                                active.Bg_img = fileName;
                                active.SubTitle = Content;
                                active.Copywrite = comingSoon.Copywrite;
                                db.SaveChanges();
