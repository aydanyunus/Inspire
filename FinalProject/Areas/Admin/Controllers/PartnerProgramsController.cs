...
{
    public class PartnerProgramsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/PartnerPrograms
        public ActionResult Index()
        {
            return View(db.PartnerPrograms.ToList());
        }

        // GET: Admin/PartnerPrograms/Details/5
        public ActionResult Details(int? id)
        {
            ...
            PartnerProgram partnerProgram = db.PartnerPrograms.Find(id);
        ...
        // GET: Admin/PartnerPrograms/Edit/5
        ...
        // POST: Admin/PartnerPrograms/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img,Content")] PartnerProgram partnerProgram, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                PartnerProgram active = db.PartnerPrograms.Find(id);
                if (active != null)
                {
                    ...
                    if (Photo != null)
                    {
                        if (Photo.ContentLength > 0 && Photo.ContentLength <= 3 * 1024 * 1024)
                        {
                            ...
                            )
                            {
                                ...
                                active.Img = fileName;
                                active.Content = partnerProgram.Content;
                                db.SaveChanges();
