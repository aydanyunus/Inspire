...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class MaintenanceBgsController : Controller
    {
        private BlogInspireEntities db = new BlogInspireEntities();

        // GET: Admin/MaintenanceBgs
        public ActionResult Index()
        {
            return View(db.MaintenanceBgs.ToList());
        }

        // GET: Admin/MaintenanceBgs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            MaintenanceBg maintenanceBg = db.MaintenanceBgs.Find(id);
            if (maintenanceBg == null)
            {
                return HttpNotFound();
            }
            return View(maintenanceBg);
        }

       
        // GET: Admin/MaintenanceBgs/Edit/5
        ...
        // POST: Admin/MaintenanceBgs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int? id, [Bind(Include = "Id,Img")] MaintenanceBg maintenanceBg, HttpPostedFileBase Photo)
        {
            if (ModelState.IsValid)
            {
                MaintenanceBg activebg = db.MaintenanceBgs.Find(id);
                if (activebg != null)
                {
